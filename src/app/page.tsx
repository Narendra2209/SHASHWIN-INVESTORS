...
const services = [
  { title: "Equity Cash", desc: "Research-driven equity cash recommendations for intraday and delivery trading.", color: "#1e40af", icon: "M3 3v18h18M9 17V9m4 8V5m4 12v-4" },
  { title: "Futures Trading", desc: "Directional futures strategies with clear entry, stop-loss and targets.", color: "#b8860b", icon: "M13 7l5 5-5 5M6 12h12" },
  { title: "Options Advisory", desc: "Data-driven options strategies with defined risk parameters.", color: "#1e40af", icon: "M12 2L2 7l10 5 10-5M2 17l10 5 10-5M2 12l10 5 10-5" },
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden pt-[72px]">
        ...
        <div className="absolute inset-0" style={{
          background: "radial-gradient(ellipse at 18% 25%, rgba(59,130,246,0.15) 0%, transparent 55%), radial-gradient(ellipse at 80% 75%, rgba(184,134,11,0.08) 0%, transparent 45%)",
        }} />
        ...
        {/* Floating accents */}
        <div className="absolute top-40 left-[6%] w-28 h-28 rounded-full border border-blue-400/[0.08]" style={{ animation: "float 8s ease-in-out infinite" }} />
        <div className="absolute top-60 right-[8%] w-16 h-16 rounded-2xl border border-amber-400/[0.08] rotate-12" style={{ animation: "float-slow 10s ease-in-out infinite 2s" }} />

        <div className="relative z-10 max-w-[1280px] mx-auto px-6 pt-20 sm:pt-24 md:pt-32 pb-20 sm:pb-24 md:pb-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            {/* Left */}
            <div>
              <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-blue-400/[0.15] bg-blue-500/[0.08] mb-8">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-60" />
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-green-400" />
                </span>
                <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-white/60">SEBI-Registered Research Analyst</span>
              </div>
              ...
              <h1 className="text-[32px] sm:text-[40px] md:text-[50px] lg:text-[58px] font-black leading-[1.04] tracking-[-0.03em] mb-7">
                ...
                <span className="relative">
                  <span className="bg-gradient-to-r from-[#d4a017] via-[#f0c040] to-[#d4a017] bg-clip-text text-transparent">Expert Research</span>
                  <span className="absolute -bottom-2 left-0 w-full h-[2px] bg-gradient-to-r from-[#d4a017]/50 via-[#d4a017]/25 to-transparent rounded-full" />
                </span>
              </h1>

              <p className="text-[15px] sm:text-[17px] md:text-[19px] text-white/50 mb-10 max-w-[520px] leading-relaxed font-normal">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-6">
                ...
                <Link href="/services" className="inline-flex items-center justify-center px-8 py-[14px] text-[14px] font-bold transition-all rounded-2xl border-1.5 border-white/15 text-white/80 hover:bg-white/5 hover:border-white/25 hover:-translate-y-0.5">
                  Our Services
                </Link>
              </div>
                ...
                <div className="flex -space-x-2">
                  {[0,1,2,3].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full border-2 border-[#0f172a] flex items-center justify-center text-[9px] font-bold text-white"
                      style={{ background: `linear-gradient(135deg, ${['#1e40af','#b8860b','#1e40af','#b8860b'][i]}, ${['#3b82f6','#d4a017','#3b82f6','#d4a017'][i]})` }}>
                      {['SK','AR','PM','VK'][i]}
                    </div>
                  ))}
                </div>
            ...
            {/* Right — Form */}
            <div className="rounded-3xl p-7 sm:p-9 relative bg-white shadow-2xl shadow-blue-900/10">
              <div className="absolute top-0 left-6 right-6 h-[3px] bg-gradient-to-r from-transparent via-[#1e40af] to-transparent rounded-full" />
              <div className="flex items-center gap-4 mb-7 mt-1">
                <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 border border-blue-200 flex items-center justify-center">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1e40af" strokeWidth="1.5"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.88.37 1.85.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.96.33 1.93.57 2.81.7A2 2 0 0 1 22 16.92z" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div>
                  <h2 className="text-[17px] font-bold tracking-tight text-gray-900">Free Consultation</h2>
                  <p className="text-[12px] text-[#1e40af] font-medium">Our analyst will call you back</p>
                </div>
              </div>
              <LeadForm />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 mt-20 sm:mt-28">
            {stats.map((s) => (
              <div key={s.label} className="rounded-3xl py-7 sm:py-9 px-6 text-center group hover:bg-white/[0.06] transition-all border border-white/[0.06]">
                <div className="w-10 h-10 rounded-xl bg-blue-500/[0.1] flex items-center justify-center mx-auto mb-4">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d={s.icon}/></svg>
                </div>
                <p className="text-[28px] sm:text-[36px] font-black tracking-tight bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent mb-1">{s.value}</p>
                <p className="text-[12px] sm:text-[13px] text-white/40 font-medium tracking-wide">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-14 lg:mb-20">
            <div className="max-w-xl">
              <span className="inline-block px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] rounded-full bg-blue-50 text-[#1e40af] border border-blue-200 mb-5">Services</span>
              <h2 className="text-[28px] sm:text-[36px] md:text-[44px] font-extrabold leading-[1.08] tracking-[-0.03em]">
                <span className="text-[#0f172a]">Advisory Across</span><br />
                <span className="text-[#64748b]">All Market Segments</span>
              </h2>
            </div>
            ...
            {services.map((s) => (
              <article key={s.title} className="glass-card relative overflow-hidden group hover:-translate-y-1 transition-all duration-400">
                ...
                <div className="p-7 sm:p-9">
                  <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-6 border transition-all duration-300 group-hover:scale-105" style={{ background: `${s.color}0a`, borderColor: `${s.color}18` }}>
                  ...
                  <h3 className="text-[17px] font-bold tracking-tight mb-2.5 text-[#0f172a]">{s.title}</h3>
      ...
      <section className="py-20 sm:py-28 bg-[#f8fafc] section-glow relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-amber-100/30 blur-3xl" />
        <div className="max-w-[1280px] mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
            {trust.map((r, i) => (
              <div key={r.title} className="glass-card p-7 sm:p-9 flex gap-6 items-start group transition-all duration-300">
                <div className="shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center border transition-all duration-300 group-hover:scale-105"
                  style={{ background: `${['#1e40af','#b8860b','#1e40af','#b8860b'][i]}0a`, borderColor: `${['#1e40af','#b8860b','#1e40af','#b8860b'][i]}18` }}>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={['#1e40af','#b8860b','#1e40af','#b8860b'][i]} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d={r.icon}/></svg>
                </div>
                <div>
