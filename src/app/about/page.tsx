...
const values = [
  ...
  { icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", title: "Discipline", desc: "Strict risk management protocols. Every recommendation has a defined risk-reward ratio.", color: "#047857" },
  ...
  { icon: "M13 10V3L4 14h7v7l9-11h-7z", title: "Speed", desc: "Real-time alerts via WhatsApp, SMS, and call so you never miss an opportunity.", color: "#047857" },
...
const timeline = [
  { year: "2008", title: "Founded", desc: "Established with a mission to deliver transparent, research-backed option trading advisory." },
  { year: "2013", title: "Option Trading Focus", desc: "Specialised in option trading strategies — our flagship offering ever since." },
  { year: "2020", title: "10K+ Clients", desc: "Crossed the milestone of serving over 10,000 active traders across India." },
  { year: "2026", title: "18+ Years, 15K+ Clients", desc: "Nearly two decades of disciplined advisory with 90% accuracy across segments." },
];
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6">
          <div className="max-w-2xl">
            ...
            <h1 className="text-[32px] sm:text-[42px] md:text-[52px] font-black leading-[1.04] tracking-[-0.03em] mb-6">
              <span className="text-white">Specialists in</span><br />
              <span className="option-highlight">Option Trading</span><br />
      ...
      <section className="py-20 sm:py-28 bg-white section-glow relative overflow-hidden">
        <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full bg-emerald-100/30 blur-3xl" />
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
          <div>
            ...
            <h2 className="text-[26px] sm:text-[34px] md:text-[42px] font-extrabold leading-[1.08] tracking-[-0.03em] mb-6">
              <span className="text-[#0f172a]">Mastering</span> <span className="option-highlight">Option Trading</span><br />
              <span className="text-[#64748b]">For 18+ Years</span>
            </h2>
            <p className="text-[14px] sm:text-[15px] text-[#64748b] leading-[1.8] mb-6">
              We specialise in <span className="text-[#b8860b] font-semibold">option trading</span> — providing strike selection, risk-managed entries, and positional strategies backed by rigorous analysis. Our analysts bring 18+ years of market experience to every call.
            </p>
            <p className="text-[14px] sm:text-[15px] text-[#64748b] leading-[1.8] mb-8">
              Whether you trade Bank Nifty options, Nifty options, or stock options, our structured approach ensures every recommendation comes with clear entry, stop-loss, and target levels.
            </p>
            <div className="flex flex-wrap gap-2.5">
              {["Option Trading Experts", "18+ Years", "90% Accuracy"].map((t) => (
                <span key={t} className="inline-flex items-center gap-2 px-4 py-2 text-[12px] font-semibold rounded-full bg-emerald-50 text-[#047857] border border-emerald-200">
                  <svg width="12" height="12" viewBox="0 0 20 20" fill="#047857"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/></svg>
                  {t}
                </span>
              ))}
            </div>
          ...
          <div className="glass-card p-10 sm:p-12 relative">
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-50/50 to-amber-50/30" />
            <svg viewBox="0 0 300 260" fill="none" className="w-full h-auto relative z-10">
              <defs><linearGradient id="ag" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#047857"/><stop offset="100%" stopColor="#b8860b"/></linearGradient></defs>
              ...
              {[[75,130],[120,160],[165,90],[210,120],[260,55]].map(([cx,cy],i)=>(
                <g key={i}><circle cx={cx} cy={cy} r="5" fill={i%2===0?"#047857":"#b8860b"} opacity="0.8"/><circle cx={cx} cy={cy} r="10" fill="none" stroke={i%2===0?"#047857":"#b8860b"} strokeWidth="1" opacity="0.2"/></g>
              ))}
      ...
      <section className="py-20 sm:py-28 bg-[#f8fafc] section-glow relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-emerald-100/30 blur-3xl" />
        <div className="max-w-[1280px] mx-auto px-6 relative z-10">
          <div className="text-center max-w-xl mx-auto mb-14 lg:mb-20">
            <span className="inline-block px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] rounded-full bg-emerald-50 text-[#047857] border border-emerald-200 mb-5">Our Journey</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            {timeline.map((t, i) => (
              <div key={t.year} className="glass-card p-7 sm:p-9 relative group transition-all">
                <div className="absolute top-0 left-0 right-0 h-[2px] opacity-40 group-hover:opacity-80 transition-opacity" style={{ background: `linear-gradient(90deg, ${i%2===0?'#047857':'#b8860b'}, transparent)` }} />
      ...
      <section className="py-20 sm:py-28 bg-[#f8fafc] section-glow relative overflow-hidden">
        ...
        <div className="max-w-[620px] mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/contact" className="btn-3d btn-3d-gold inline-flex items-center justify-center px-8 py-[14px] text-[14px]">Contact Us</Link>
