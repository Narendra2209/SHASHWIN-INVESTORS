...
const methods = [
  { title: "Call Us", desc: "Speak directly with our team", value: "+91-7032048807", href: "tel:+917032048807", icon: "M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.88.37 1.85.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.96.33 1.93.57 2.81.7A2 2 0 0 1 22 16.92z", color: "#1e40af" },
  ...
  { title: "Visit Us", desc: "Our office", value: "Kurla West, Mumbai 400070", href: "#office", icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z", color: "#1e40af" },
];
      ...
      <section className="page-hero">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 text-center">
          ...
          <h1 className="text-[32px] sm:text-[42px] md:text-[52px] font-black leading-[1.04] tracking-[-0.03em] mb-6 max-w-3xl mx-auto">
            ...
            <span className="text-[#d4a017]">Trading Journey</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-14">
            ...
            <div className="lg:col-span-3">
              <div className="glass-card p-7 sm:p-10 relative">
                <div className="absolute top-0 left-8 right-8 h-[2px] bg-gradient-to-r from-transparent via-[#1e40af]/20 to-transparent rounded-full" />
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              <div className="glass-card p-6 sm:p-8">
                <h3 className="text-[15px] font-bold mb-5 text-[#0f172a] tracking-tight flex items-center gap-2.5">
                  <span className="w-6 h-6 rounded-lg bg-blue-50 border border-blue-200 flex items-center justify-center">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#1e40af" strokeWidth="2" opacity="0.7"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                  </span>
                  Business Hours
                </h3>
              ...
              <div className="glass-card p-6 sm:p-8 relative" id="office">
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-blue-50/30 to-amber-50/20" />
                <div className="relative z-10">
                  <h3 className="text-[15px] font-bold mb-3 text-[#0f172a] tracking-tight">Office Address</h3>
                  ...
                  <p className="text-[11px] text-[#1e40af] font-semibold">SEBI Reg: INH000XXXXXX</p>
                </div>
              </div>
            </div>
          </div>
