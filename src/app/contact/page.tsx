...
const methods = [
  ...
  { title: "Visit Us", desc: "Our office", value: "8th Phase, JP Nagar, Bangalore", href: "#office", icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z", color: "#047857" },
];
              ...
              <div className="glass-card p-6 sm:p-8 relative" id="office">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[12px] text-[#94a3b8] leading-relaxed mb-4">
                    Landmark: Near BESCOM bus stop
                  </p>
                  <p className="text-[11px] text-[#b8860b] font-bold uppercase tracking-[0.12em]">SEBI Registered Research Analyst</p>
                </div>
              </div>
            </div>
          </div>
